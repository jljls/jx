...
@RequestMapping("/")
@Async
public class VeinController1 {

	private static Logger logger = LoggerFactory.getLogger(VeinController1.class);
	...
	@ResponseBody
	public MessageResult check1(@RequestBody String jsonString){
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "checkAllToN1", method = RequestMethod.POST)
	@ResponseBody
	public MessageResult checkAllToN1( @RequestBody String jsonString){
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "checkToNByGroupId1", method = RequestMethod.POST)
	@ResponseBody
	public MessageResult checkToNByGroupId1( @RequestBody String jsonString){
		JSONObject object = JSONObject.fromObject(jsonString);
